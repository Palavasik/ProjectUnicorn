...
- Геокодинг города через ORS Geocode API
- Построение кругового маршрута через ORS Directions (foot-walking)
- Фильтрация по типу поверхности (extras.surface)
- Fallback на JSON при ошибках ORS
